...
class SparkleDiscoveryTest(unittest.TestCase):
    def setUp(self):
        self.tmp = pathlib.Path(tempfile.mkdtemp(prefix="roamex-fw-"))
...
class RenameBundleTest(unittest.TestCase):
    def test_chromium_app_becomes_roamex_app(self):
        import plistlib
        tmp = pathlib.Path(tempfile.mkdtemp(prefix="roamex-rn-"))
