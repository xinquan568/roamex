...
#ifndef ROAMEX_UTILITY_IMPORTER_EDGE_PROFILE_READER_H_
#define ROAMEX_UTILITY_IMPORTER_EDGE_PROFILE_READER_H_
...
#endif  // ROAMEX_UTILITY_IMPORTER_EDGE_PROFILE_READER_H_
