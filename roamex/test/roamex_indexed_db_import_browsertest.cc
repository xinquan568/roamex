...
constexpr char kSeedJs[] = R"(
  new Promise((resolve, reject) => {
    const open = indexedDB.open('roamexdb', 1);
...
class RoamexIndexedDbImportTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(RoamexIndexedDbImportTest,
  ...
  RoamexIndexedDbImportStage stage(edge.GetPath(),
