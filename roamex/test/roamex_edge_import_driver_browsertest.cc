...
// roamex_edge_import_coordinator_browsertest.cc.

#include "roamex/browser/importer/roamex_edge_import_driver.h"
...
class RoamexEdgeImportDriverTestBase : public InProcessBrowserTest {
 public:
 ...
 protected:
  ...
  EdgeImportReport RunDriver(const base::FilePath& app_data_root,
                             uint16_t items) {
    RoamexEdgeImportDriver driver(browser()->profile(), app_data_root, items,
...
class RoamexEdgeImportDriverTest : public RoamexEdgeImportDriverTestBase {
 public:
  RoamexEdgeImportDriverTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexEdgeImportDriverTest,
...
class RoamexEdgeImportDriverDisabledTest
    : public RoamexEdgeImportDriverTestBase {
 public:
  RoamexEdgeImportDriverDisabledTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexEdgeImportDriverDisabledTest,
