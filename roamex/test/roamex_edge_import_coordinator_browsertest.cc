...
// destination. Modeled on roamex_three_carrier_survival_browsertest.cc.
...
class RoamexEdgeImportCoordinatorTestBase : public InProcessBrowserTest {
 public:
 ...
 protected:
  ...
  EdgeImportReport RunCoordinator(const base::FilePath& app_data_root,
    ...
    RoamexEdgeImportCoordinator coordinator(
...
class RoamexEdgeImportCoordinatorTest
    : public RoamexEdgeImportCoordinatorTestBase {
 public:
  RoamexEdgeImportCoordinatorTest() {
...
class RoamexEdgeImportCoordinatorDisabledTest
    : public RoamexEdgeImportCoordinatorTestBase {
 public:
  RoamexEdgeImportCoordinatorDisabledTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexEdgeImportCoordinatorDisabledTest,
